...
echo "subject: JU-Official website resource and database backup notice    $(date +'%d-%m-%Y %H:%M:%S')" >> "email.txt"
echo "to: <firewlegese74@gmail.com>, <firewlegese14@gmail.com> " >> "email.txt"
...
scp -r $DESTDIR$FILENAME     'ghost@10.140.11.171:/home/ghost/Desktop/webresource'
scp -r $BKP_DEST    'ghost@10.140.11.171:/home/ghost/Desktop/webdb'
echo "The JU-Official website and  database has been copied  to the local computer successfully! at  $(date +'%d-%m-%Y %r') " >>  "email.txt"

echo "Regards, " >>  "email.txt"
echo "Admin" >>  "email.txt"
echo "This is autogenerated email, Please donot reply!" >>  "email.txt"
curl --url 'smtps://smtp.gmail.com:465' --ssl-reqd \
 ...
 --upload-file email.txt  --user 'juservicesbackup@gmail.com:password' --insecure
rm -r email.txt
#########################################################################################
